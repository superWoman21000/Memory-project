...
$sqlEntrepreneurs = "SELECT e.id_Entrepreneur, e.nom, e.prenom 
                     ...
                     INNER JOIN chefProjetEntrepreneur cpe ON e.id_Entrepreneur = cpe.id_Entrepreneur 
...
$sqlProjets = "SELECT p.id_Projet, p.Nom_Projet
               FROM projet p 
               INNER JOIN BureauEtude_Projet bep ON p.id_Projet = bep.id_Projet 
               WHERE bep.id_BureauEtude = $BureauEtudeID";
